...
/**
 * Note: Modal là một low-component mà bọn MUI sử dụng bên trong những thứ như Dialog, Drawer, Menu, Popover.Ở đây dĩ nhiên chúng ta có thể
 * sử dụng Dialog cũng không thành vấn đề gì, nhưng sẽ sử dụng Modal để dễ linh hoạt tùy biến giao diện từ con số 0 cho phù hợp với mọi nhu cầu nhé.
 */
function ActiveCard() {
  ...
  const onUpdateCardMembers = (incomingMemberInfo) => {
    callApiUpdateCard({ incomingMemberInfo }) // dat trong {} de vua tao value va cung dong thoi tao key
  }
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              {/* Neu user dang dang nhap hien tai chua la thanh vien cua card thi moi hien nut Join */}
              {/* Hanh dong nay luon la ADD */}
