...
function AccountTab() {
  ...
  const uploadAvatar = (e) => {
    ...
    reqData.append('avatar', e.target?.files[0]) // them file vao trong reqData bang append cua FormData
    ...
    toast.promise(
      ...
      // Du co loi hay thanh cong thi cung phai clear gia tri cua file input, neu kh thi se kh the chon cung mot file lien tiep duoc
      e.target.value = ''
    })
  }
