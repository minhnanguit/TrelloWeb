 ...
 * Note: Modal là một low-component mà MUI sử dụng bên trong những thứ như Dialog, Drawer, Menu, Popover. Ở đây dĩ nhiên chúng ta có thể sử dụng Dialog cũng không thành vấn đề gì, nhưng sẽ sử dụng Modal để dễ linh hoạt tùy biến giao diện từ con số 0 cho phù hợp với mọi nhu cầu.
 */
function SidebarCreateBoardModal({ afterCreateNewBoard }) {
  ...
  const submitCreateNewBoard = (data) => {
    ...
    createNewBoardAPI(data).then(() => {
      // Dong model
      handleCloseModal()
      // refresh lai boards list bang cac nhan prop thi component cha
      afterCreateNewBoard()
    })
  }
