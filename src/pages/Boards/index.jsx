...
import Grid from '@mui/material/Unstable_Grid2' // Grid: https://mui.com/material-ui/react-grid2/#whats-changed
...
function Boards() {
  ...
  useEffect(() => {
    ...
    fetchBoardsAPI(location.search)
      .then(res => {
        // Gan ket qua res tra ve phia BE (boardModel) vao 2 cai state boards & totalBoards
