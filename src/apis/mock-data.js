export const mockData = {
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://th.bing.com/th/id/R.8e07caeb4ef19dcb579ff17170cbcc05?rik=mX67HJcVF3w1YQ&pid=ImgRaw&r=0',
      ...
      // Phia FE se tao ra 1 card dac biet: Placeholder Card, kh lien quan toi BE
      // Card nay se duoc an o UI
      // Cau truc id: columnId-placeholder-card (moi column chi toi da 1 placeholder card)
      {
        _id: 'column-id-04',
        boardId: 'board-id-01',
