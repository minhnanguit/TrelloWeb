...
/**
 * Custom một cái hook để dùng cho việc debounce function, nhận vào 2 tham số là function muon delay và thời gian delay
...
export const useDebounceFn = (fnToDebounce, delay = 500) => {
  ...
  // Bọc cái thực thi debounce từ lodash vào useCallback để tránh re-render nhiều lần, chỉ re-render khi fnToDebounce hoặc delay thay đổi
